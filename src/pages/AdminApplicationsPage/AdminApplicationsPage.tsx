        ...
        <div className={styles['admin__page-wrapper']}>
          ...
          className={styles['form']}>
              <div className={styles.form__item}>
                <Form.Control onChange={(event: ChangeEvent<HTMLInputElement>) => {setStartTime(event.target.value)}} value={startTime} className={styles.form__input} type="text" placeholder="Начальная дата (Год-Месяц-День)*" />
              </div>
              <div className={styles.form__item}>
                <Form.Control onChange={(event: ChangeEvent<HTMLInputElement>) => {setEndTime(event.target.value)}} value={endTime} className={styles.form__input} type="text" placeholder="Конечная дата (Год-Месяц-День)*" />
              </div>
