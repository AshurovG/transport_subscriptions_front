  ...
  return (
    <div className={styles.registration__page}>
      ...
      <div
        ...
        className={styles["registration__page-wrapper"]}
      >
        <Form onSubmit={handleFormSubmit} className={styles["form"]}>
          ...
          <div className={styles.form__item}>
            <Form.Group
              ...
              controlId="search__sub.input__sub"
            >
              <Form.Control
                onChange={handleEmailValueChange}
                value={emailValue}
                style={{ height: "100%", borderColor: "#3D348B", fontSize: 18 }}
                type="email"
                placeholder="E-mail..."
              />
              <span className={styles["form__item-error"]}>
                {emailError !== "init" && emailError}
              </span>
            </Form.Group>
          </div>
          <div className={styles.form__item}>
            ...
            >
              ...
              />
              <span className={styles["form__item-error"]}>
                {fullnameError !== "init" && fullnameError}
              </span>
            </Form.Group>
          </div>
          <div className={styles.form__item}>
            ...
            >
              ...
              />
              <span className={styles["form__item-error"]}>
                {phoneNumberError !== "init" && phoneNumberError}
              </span>
            </Form.Group>
          </div>
          <div className={styles.form__item}>
            ...
            >
              ...
              />
              <span className={styles["form__item-error"]}>
                {passwordError !== "init" && passwordError}
              </span>
            </Form.Group>
          </div>
          ...
          <Link className={styles["registration__page-link"]} to="/login">
