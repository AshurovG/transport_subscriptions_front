        ...
        <div className='main__page'>
            ...
            <div style={{position: 'relative'}}className={styles['content']}>
                ...
                boxShadow: '0px 4px 10px 0px rgba(0, 0, 0, 0.25)', borderRadius: '10px'}}>
                    ...
                    <Button type='submit' style={{backgroundColor: "#2787F5", padding: "15px 20px", borderColor: "#000", fontSize: 18, height: 60}}>Зарегистрироваться</Button>
                    <Link className={styles.content__link} to='/'>У вас уже есть аккаунт?</Link>
                </Form>
            </div>
        </div>
    )
