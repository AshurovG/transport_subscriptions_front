    ...
    <div className={styles.header}>
      <div className={styles.header__wrapper}>
        ...
        <div className={styles.header__blocks}>
          <Link className={styles.header__block} to="/subscriptions">
            Виды абонементов
          </Link>
          {isUserAuth && (
            <Link className={styles.header__block} to="/applications">
              Мои заявки
            </Link>
          )}
        </div>
        ...
        <div className={styles.header__icons}>
          {isUserAuth && (
            <div className={styles["application__icon-wrapper"]}>
              <Link to={"/application"}>
                <div className={styles["application__icon-circle"]}>
          ...
          {isUserAuth ? (
            <ProfileIcon
              className={styles["header__profile-icon"]}
              onClick={handleProfileButtonClick}
            />
          ) : (
            <Link to="/registration" className={styles.header__profile}>
              <ProfileIcon />
            </Link>
          )}
